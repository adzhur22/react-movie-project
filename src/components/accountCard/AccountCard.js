...
export function AccountCard(){
    ...
    <div className={css.AccountCard}>
        <div className={css.image} onClick={()=> navigate('/change-avatar')}>
            {accountDetails?.avatar?.tmdb?.avatar_path ? <img src={baseURLImage.profile_sizes.w185 + accountDetails.avatar.tmdb.avatar_path} alt={'Avatar'}/> : <img src={'https://cdn-icons-png.flaticon.com/512/149/149071.png'} alt={'Avatar'}/>}
        </div>
